...
class SecondsAndMinutes{
    public static String getDurationString(long minutes, long seconds){
        if((minutes < 0 ) && (seconds < 0 || seconds >=59)){
            ...
            return "hours : " + hours + "hr. Mins : " + remainingMinutes + "mins. Seconds : " + seconds + "secs.";
        }
    }
    ...
    public static void main(String[]args){
        ...
        System.out.println("Enter the minutes and seconds :");
        long minutes = sc.nextLong();
        long seconds = sc.nextLong();
        System.out.println("Duration 1 : " + getDurationString(minutes,seconds));
        System.out.println("Enter the seconds : ");
        long sec = sc.nextLong() ;
        System.out.println("Duration 2 : " + getDurationString(sec));
        sc.close();   
    }
}